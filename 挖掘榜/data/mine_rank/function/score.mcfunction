...
scoreboard objectives add golden_pickaxe used:golden_pickaxe
scoreboard objectives add golden_axe used:golden_axe
scoreboard objectives add golden_shovel used:golden_shovel
scoreboard objectives add golden_hoe used:golden_hoe

scoreboard objectives add iron_pickaxe used:iron_pickaxe
...
scoreboard objectives add wooden_pickaxe used:wooden_pickaxe
